...
多说一句，为什么我会这么重视白板功能？因为首先你得确定，自己在记笔记的时候属于什么样类型，或者叫你是什么样的学习类型？Tiago 在他的视频当中分成了四种，图书管理员、架构师、园丁和学生，但这只是名词的代表。如果你是架构师或园丁，需要去做一些思考上的事情比较多的话，那你随时都需要头脑风暴并且产出结论。所以说你就需要白板化、可视化工具，先搜索和探索，再对内容进行合理的摆放。
...
好，当我梳理了整个逻辑道理之后，我就可以进入到快速产出这部分了，也找到主题写成线程，进行分享，处理成文章。相应的，当我们去快速产出的时候，借助于模板，我们就可以快速去填充对应的卡片。比方说我这里有写很多的模板，拿最简单的专栏写作来说，首先是描述概念，Roam Research 的功能以及哪些参考资料。当然我前文也有介绍过像 morning routine 这样简单的，比如说什么在我的脑海里，我今天要吃哪只青蛙等等，模板。

整理思路的时候，现在能做什么呢？整理大纲，梳理，用白板来梳理大纲。同时我要去快速地向别人展示，获得对应的反馈，最好是面对面的沟通。以此循环，构建学习闭环，define build measure learn，再拆分为不同的主题，当然最重要的还是去设置路线上的里程碑。话我们就有了路线图，从 A 到 B 再到 C 再到 D 以及我们在达成某个里程碑或者在预期时间没有达成里程碑的时候，可以进行阶段性的评估。当然另外我们也可以进行量化系统的数据化统计，准备投入多少个番茄，产出什么样的东西，获得什么样的效果等等。
