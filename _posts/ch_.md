...
好，当我梳理了整个逻辑道理之后，我就可以进入到快速产出部分了，也找到主题写成线程，进行分享，处理成文章。相应的，当我们去快速产出的时候，借助于模板，我们就可以快速去填充对应的卡片。比方说我这里有写很多的模板，拿最简单的专栏写作来说，首先是描述概念，Roam Research 的功能以及哪些参考资料。当然我前文也有介绍过像 morning routine 这样简单的，比如说什么在我的脑海里，我今天要吃哪只青蛙等等，模板。

当我填充完这个数据之后，今天的这个城建日记其实就完成了。当然我写作上也会有一些模板，比方说当我去思考一个新的模型的时候，我会以这样一个结构，也就是希望达成哪些效果。然后有哪些利益相关者谁会从这个预期效果中获益，以及哪些人会持有对我有帮助的重要信息。然后谁是这个 decoder 也就是跟他利益相关的，并且是支持整个项目的最重要的人。当然最重要的是我们需要在短时间内找到一个验证效果的最小可行思路。

接下来能做什么呢？整理大纲，梳理，用白板来梳理大纲。同时我要去快速地向别人展示，获得对应的反馈，最好是面对面的沟通。以此循环，构建学习闭环，define build measure learn，再拆分为不同的主题，当然最重要的还是去设置路线上的里程碑。话我们就有了路线图，从 A 到 B 再到 C 再到 D 以及我们在达成某个里程碑或者在预期时间没有达成里程碑的时候，可以进行阶段性的评估。当然另外我们也可以进行量化系统的数据化统计，准备投入多少个番茄，产出什么样的东西，获得什么样的效果等等。
